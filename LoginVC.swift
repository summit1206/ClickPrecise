...
class LoginVC: UIViewController, UITextFieldDelegate, UIGestureRecognizerDelegate {
  ...
  @IBAction func loginDidTouch(_ sender: Any) {
    ...
    if textBox.text!.isEmpty {
      ...
      textBox.attributedPlaceholder = NSAttributedString(string: "Think of a nickname", attributes: [NSAttributedStringKey.foregroundColor: UIColor(red: 232/255, green: 45/255, blue: 111/255, alpha: 100)])
    } else {
      //скрываем клавиатуру
